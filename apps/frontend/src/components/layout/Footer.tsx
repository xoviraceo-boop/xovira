export default function Footer() {
  return (
    <footer className="w-full border-t border-cyan-100 bg-gradient-to-r from-white via-cyan-50/30 to-white mt-auto">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="py-8 sm:py-12">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {/* Brand Section */}
            <div className="col-span-1 sm:col-span-2 lg:col-span-1">
              <h3 className="font-bold text-xl bg-gradient-to-r from-cyan-600 to-blue-600 bg-clip-text text-transparent mb-3">
                xovira
              </h3>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <a href="/explore" className="text-sm text-slate-600 hover:text-cyan-600 transition-colors">
                    Explore
                  </a>
                </li>
                <li>
                  <a href="/marketplace" className="text-sm text-slate-600 hover:text-cyan-600 transition-colors">
                    Marketplace
                  </a>
                </li>
                <li>
                  <a href="/dashboard" className="text-sm text-slate-600 hover:text-cyan-600 transition-colors">
                    Dashboard
                  </a>
                </li>
              </ul>
        ...
        {/* Bottom Bar */}
        <div className="border-t border-cyan-100 py-6">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-sm text-slate-600">
              © {new Date().getFullYear()} xovira. All rights reserved.
            </p>
            <div className="flex items-center gap-6">
              <a href="#" className="text-slate-400 hover:text-cyan-600 transition-colors" aria-label="Twitter">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" />
                </svg>
              </a>
              <a href="#" className="text-slate-400 hover:text-cyan-600 transition-colors" aria-label="GitHub">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <a href="#" className="text-slate-400 hover:text-cyan-600 transition-colors" aria-label="LinkedIn">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
