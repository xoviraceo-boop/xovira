    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://xovira.sentry.io/issues/?project=4510113219739648">Issues Page</a>.
