...
-- CreateEnum
CREATE TYPE "ConversationType" AS ENUM ('GENERAL', 'PROJECT_HELP', 'TEAM_COORDINATION', 'BRAINSTORMING', 'CODE_REVIEW', 'DOCUMENT_QA', 'MENTORSHIP', 'AGENT_BUILDER', 'AGENT_EXECUTOR', 'AGENT_OPERATOR');
