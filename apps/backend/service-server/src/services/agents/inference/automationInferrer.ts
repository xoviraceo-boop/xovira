...
import { AutomationTriggerType, TriggerType } from '../types';
import {
...
import { AutomationInferenceResponseSchema, InferredAutomationSchema, InferredAutomationTriggerSchema } from '../schemas';
...
Infer automations.`,
    ...
    const estimatedTokens = this.tokenBudgetManager.estimateTokens(JSON.stringify(inferenceMessages)) + 1200;
    const budgetCheck = await this.tokenBudgetManager.checkBudget('automation', estimatedTokens);
