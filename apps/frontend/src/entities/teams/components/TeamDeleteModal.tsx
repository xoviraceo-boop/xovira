...
export function TeamDeleteModal({ teamId, teamName, open, onOpenChange, onSuccess }: TeamDeleteModalProps) {
            ...
            queryClient.setQueriesData({ queryKey: [['team', 'listInfinite']] }, (oldData: any) => {
                ...
                return {
                    ...
                    pages: oldData.pages.map((page: any) => ({
                        ...page,
                        items: page.items.filter((item: any) => item.id !== teamId)
                    }))
                };
            });
        },
        onSuccess: () => {
            toast({ title: "Team deleted permanently" });
    ...
    const isDeleteEnabled = confirmText === teamName && understood;
            ...
            <DialogContent className="sm:max-w-[540px]">
                    ...
                    <div className="space-y-4">
                        <div className="space-y-2">
                            <Label className="text-sm font-medium text-slate-900">
                                Type <code className="px-1.5 py-0.5 bg-red-100 text-red-700 rounded text-xs font-mono">{teamName}</code> to confirm
                            </Label>
                            <Input
                                value={confirmText}
                ...
                <DialogFooter className="gap-2 pt-4">
                    ...
                    <Button
                        ...
                        disabled={!isDeleteEnabled || deleteTeam.isPending}
                    >
