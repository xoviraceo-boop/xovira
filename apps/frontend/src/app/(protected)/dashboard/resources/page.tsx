...
import { ResourceCreationModal } from "@/entities/resources/components/ResourceCreationModal";
import { ResourceFilterSidebar } from "@/entities/resources/components/ResourceFilterSidebar";
import { useResourceList } from "@/entities/resources/hooks/useResourceList";
...
export default function ResourcesPage() {
    ...
    const handleCreatedResource = (id: string) => {
	...
	return (
		...
		<Shell>
			<div className="grid grid-cols-1 gap-0 lg:grid-cols-[1fr_var(--filter-sidebar-width,_18rem)]">
				<div className="order-2 space-y-6 lg:order-1 lg:pr-4">
                    ...
                    <SearchSection
                        searchValue={query}
                        searchPlaceholder="Search resources by title, category, or keyword..."
					...
					{isLoading ? (
                        ...
                        <div className="flex min-h-[320px] flex-col items-center justify-center rounded-lg border-2 border-dashed border-muted bg-muted/10 p-8 text-center">
                            ...
                            <h3 className="mt-4 text-lg font-semibold text-foreground">No resources published</h3>
                            <p className="mt-2 text-sm text-muted-foreground">
                                {query ? "Try adjusting your search or filters." : "Share your resources with the community by adding a resource."}
                            </p>
        ...
        <ResourceCreationModal
            ...
            onCreated={handleCreatedResource}
        />
        </>
    );
}
