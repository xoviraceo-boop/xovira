...
export const AgentChatBuilder: React.FC<AgentChatBuilderProps> = ({
  ...
  const handleSendMessage = useCallback(async (message: string) => {
    ...
    messageMutation.mutate({
      conversationId,
      message,
      agentId: agentId || (agentDraft as any)?.id || agentData?.id
    });
  }, [messageMutation, conversationId, isSending, messages, markFollowupsConsumedMutation, agentId, agentDraft, agentData]);
              ...
              <div className="relative flex-1 overflow-hidden">
                <ChatMessageList
                  ...
                  pendingAssistantMessage={
                    isSending ? <ThinkingIndicator stage={conversationState?.stage || 'analyzing'} /> : null
                  }
