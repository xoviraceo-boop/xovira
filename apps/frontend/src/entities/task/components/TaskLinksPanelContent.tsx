...
interface TaskLinksPanelContentProps {
    taskId: string;
    workspaceId?: string;
...
export function TaskLinksPanelContent({ taskId, workspaceId, linkedItems = [] }: TaskLinksPanelContentProps) {
    ...
    return (
        <div className="flex flex-col h-full min-h-0">
            ...
            <div className="rounded-lg border border-zinc-200 overflow-hidden bg-white flex-1 min-h-0 flex flex-col mx-4 mb-3">
                <div className="flex items-center gap-2 py-2.5 px-3 border-b border-zinc-100">
                    <Check className="h-4 w-4 text-zinc-500" />
                    <span className="text-sm font-medium text-zinc-900">Linked {linkedItems.length}</span>
                </div>
