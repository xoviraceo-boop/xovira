            ...
            <header className="space-y-3 border-b pb-4">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <Badge variant={resource.isPublic ? "default" : "secondary"} className="text-sm font-semibold">
                            {resource.isPublic ? "Public" : "Private"}
                        </Badge>
                    </div>
                </div>
                <p className="max-w-4xl text-lg text-muted-foreground">{resource.description || "No description provided for this resource."}</p>
            </header>
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="space-y-2 pt-2 border-t">
                                <div className="text-xs flex items-center justify-between">
                                    ...
                                    <span className="font-medium text-foreground">{resource.createdAt.toLocaleDateString()}</span>
                                </div>
                                <div className="text-xs flex items-center justify-between">
                                    <span className="text-muted-foreground flex items-center gap-1"><Clock className="h-3 w-3"/> Last Updated</span>
                                    <span className="font-medium text-foreground">{resource.updatedAt.toLocaleDateString()}</span>
                                </div>
                            </div>
                        </CardContent>
                    </Card>
                        ...
                        <CardContent className="flex flex-col gap-3">
                            ...
                            {resource.externalUrl && (
                                <Button variant="outline" className="w-full">
                                    <a href={resource.externalUrl} target="_blank" rel="noreferrer" className="inline-flex items-center justify-center gap-2">
