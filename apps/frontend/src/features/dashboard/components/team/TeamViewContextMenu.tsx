...
interface TeamViewContextMenuProps {
    view: any;
...
const OverviewMenu = ({ view, onToggleLock, onToggleDefault, onCopyLink }: TeamViewContextMenuProps) => (
    <>
...
const ViewMenus: Partial<Record<ViewType, React.FC<TeamViewContextMenuProps>>> = {
    OVERVIEW: OverviewMenu,
};

export const TeamViewContextMenu = (props: TeamViewContextMenuProps) => {
